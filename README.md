...
```
portfolio_v2/
├── assets/         # Screenshots, resume, and other assets
...
```bash
git clone https://github.com/harshit36singh/portfolio_v2.git
```
